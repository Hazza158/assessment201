...
print()
# get serving size
needed_size = num_check("how many people are you serving?", "sorry this must be more than zero, please try again", int)
print()
...
while True:
    ...
    needed_amount = num_check("How much of the ingredient do you need? (grams): ", "please enter a number that is more than zero", float)
    print()
